        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return regeneratorRuntime.awrap(fetch(url, {
              //запишется promise будет ждать ответ
              method: "POST",
              body: data
            }));
...
//Работа с модальными окнами, чтобы открывалось и закрывалось, при нажатии на крестик и вне области окна
var modals = function modals() {
  ...
  function showModalByTime(selector, time) {
    // показывать окно если пользователь продолжительно время находится на странице
    setTimeout(function () {
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  tab = document.querySelectorAll(tabSelector),
      //таб
  content = document.querySelectorAll(contentSelector); //активный класс
  ...
  header.addEventListener('click', function (e) {
    ...
    if (target && (target.classList.contains(tabSelector.replace(/\./, '')) // .class => class
    || target.parentNode.classList.contains(tabSelector.replace(/\./, '')))) {
      // ловим клик на элементе
